...
public class ParserUtilTest {
    ...
    public void parseName_invalidLength_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseName(INVALID_NAME_LENGTH));
    }

    @Test
    public void parseName_maxLength_success() throws Exception {
        Name expectedName = new Name(VALID_NAME_MAXLENGTH);
        Name actualName = ParserUtil.parseName(VALID_NAME_MAXLENGTH);
    }
