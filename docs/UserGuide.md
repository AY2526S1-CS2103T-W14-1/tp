...
| **List**     | `list`                                                                                       | `list`                                                                             |
| **Edit**     | `edit INDEX [n/NAME] [p/PHONE_NUMBER] [e/EMAIL] [c/CLASS] [l/LABEL [t/TAG] [a/ASSIGNMENT]…​` | `edit 2 n/James Lee e/jameslee@example.com`                                        |
| **View**     | `view {n/NAME                                                                                | c/CLASS                                                                            | a/ASSIGNMENT}`                                                                         | `view n/James Lee`, `view c/Class 10B`, `view a/Tutorial 1`                                               |
| **Delete**   | `delete {INDEX                                                                               | n/NAME | c/CLASS}`                                                                          | `delete 3`, `delete n/John Doe`, `delete c/Class 10B`                                                    |
